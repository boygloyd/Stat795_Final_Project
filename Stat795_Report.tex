...
In addition to the force being used to hit the ball, the trajectory of the ball will have an impact on how far each ball will travel. 
%Different golfers hit the ball at different angles (improper swings)
For this reason the trajectory of the ball after impact was measured for each ball.
