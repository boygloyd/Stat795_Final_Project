...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in getURL("{}https://raw.githubusercontent.com/boygloyd/Stat795\_Final\_Project/master/Presentation/data/prov1\_f.csv"{}): could not find function "{}getURL"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in colnames(golf) = c("{}hitnum"{}, "{}block"{}, "{}ballnum"{}, "{}ballmodel"{}, : object 'golf' not found}}\end{kframe}
\end{knitrout}
\doublespacing
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(ballmodel, total\_distance, xlab = "{}Ball model"{}, ylab = "{}Total distance"{}): object 'ballmodel' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(ballmodel, carry, xlab = "{}Ball model"{}, ylab = "{}Carry"{}): object 'ballmodel' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(ballmodel, c\_disp, xlab = "{}Ball model"{}, ylab = "{}Carry Dispersion"{}): object 'ballmodel' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cbind(carry, c\_disp, total\_distance, t\_disp, traj): object 'carry' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in corrplot(pcorr): could not find function "{}corrplot"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(total\_distance, traj): object 'total\_distance' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y, setLab = FALSE): object 'traj' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'traj' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(fit.2): object 'fit.2' not found}}\end{kframe}
