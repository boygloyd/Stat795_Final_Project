...
The golfing associations which govern the size of golf balls, R&A and United States Golf Association, specify that the mass of a ball must be no more than 1.620 oz and have a diameter at least 1.680 inches. Any golf balls that do not meet those regulations cannot be used in tournaments. The company Titlest are being sued because some of their new balls are performing below standard. This analysis is to find out if the company is truly washing and refurbishing their balls (ProV1392 model) and selling them as new. 
...
%(Ask what differentiates washed and refurbished)
